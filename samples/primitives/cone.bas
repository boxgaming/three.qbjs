...
Viewer.Create "ConeGeometry", @CreateGeometry
Viewer.AddControl "radius", 1, 10, 6
...
Function CreateGeometry (opts As Object)
    ...
    CreateGeometry = THREE.ConeGeometry( _
        opts.radius, opts.height, opts.radialSegments, opts.heightSegments, _
